    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('inPrice', models.FloatField(default=0)),
                ('brandID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.Brand')),
                ('electronicID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product.Electronic')),
            ],
        ),
        migrations.CreateModel(
            name='MobilePhone',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star_rate', models.IntegerField(choices=[(1, 1), (2, 2), (3, 3), (4, 4)], default=0)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            name='itemID',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product.Item'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CategoryBookID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.CategoryBook')),
                ('authorID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.Author')),
                ('itemID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product.Item')),
                ('publisherID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.Publisher')),
            ],
        ),
    ]
